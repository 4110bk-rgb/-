...
const EXCLUDED_MANAGER_IDS = new Set([
  ...
  '43', // Матвеенко Сергей — руководитель монтажного отдела, не продажи
  '51', // Мызников Евгений — замерщик
  '53', // Митяев Сергей — бригадир монтажников
  '29', // Удалённый пользователь Bitrix24 (нет карточки/имени)
]);
